<?php
    ...
    if( isset($_GET['id']) AND isset($_GET['firstName']) AND isset($_GET['lastName']) ){
        $personID = $_GET['id'];
            ...
            <div class="form-row">
                <div class="confirm_button col-lg-12">
                     <a id="user-id" class="btn btn-danger" href="">Cancel</a>
                      <input type="submit" name="perform_a_vaccine_without_apm" class="btn btn-dark pull-right" value="Perform a vaccine" >
                </div>
            </div>
        </form>
    </div>
