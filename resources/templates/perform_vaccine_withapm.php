...
function search_appointment($a){
  ...
  $personID = (int) $a;
  $query = "SELECT person.personID, person.firstName, person.lastName, facility.address, facility.facilityID 
  ...
  if($result = $mysqli-> query($query)){
    while ($row = $result->fetch_assoc()){
      ...
      <tr role="row">
          ...
          <td>
              <button type="button" class="btn btn-sm btn-dark" onclick ="window.location.href = 'index.php?performingform&id=$personID&facilityID=$facilityID'">Confirm</button>
          </td> 
      </tr> 
