...
if(isset($_GET['SSN'])){
    ...
    $query = "SELECT SSN,employee_ID,startDate,endDate,facilityID,hourly_rate FROM assignment WHERE SSN = $SSN  AND employee_ID = $employee_ID AND facilityID = $facilityID;";
            ...
            <div class="form-row">
                <div class="confirm_button col-lg-12">
                     <a id="user-id" class="btn btn-danger" href="">Delete</a>
                      <input type="submit" name="update_assignment" class="btn btn-dark pull-right" value="Update changes" >
                </div>
            </div>
        </form>
    </div>
